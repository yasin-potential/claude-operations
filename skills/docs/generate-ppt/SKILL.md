---
name: generate-ppt
description: "Generate HTML presentations with Potential Inc branding using a two-step workflow (topic → markdown → HTML). Invoke when user needs a presentation."
