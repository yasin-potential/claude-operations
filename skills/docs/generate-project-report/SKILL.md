...
All references located under `skills/docs/generate-project-report/references/`:
...
| File | Purpose |
|------|---------|
| `skills/docs/generate-project-report/references/report-template.md` | Korean report output template (10 sections) |
| `skills/docs/generate-project-report/references/analysis-prompts.md` | Agent prompt specs, framework detection, scan patterns |
